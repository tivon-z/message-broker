...
import pub.broker.msgbroker.admin.api.feign.RemoteClientDetailsService;
import pub.broker.msgbroker.admin.api.vo.TokenVo;
...
import pub.broker.msgbroker.common.core.util.RetOps;
...
import pub.broker.msgbroker.common.security.util.OAuth2EndpointUtils;
import pub.broker.msgbroker.common.security.util.OAuth2ErrorCodesExpand;
import pub.broker.msgbroker.common.security.util.OAuthClientException;
...
public class MsgbrokerTokenEndpoint {

	private final HttpMessageConverter<OAuth2AccessTokenResponse> accessTokenHttpResponseConverter = new OAuth2AccessTokenResponseHttpMessageConverter();

	private final AuthenticationFailureHandler authenticationFailureHandler = new MsgbrokerAuthenticationFailureEventHandler();
