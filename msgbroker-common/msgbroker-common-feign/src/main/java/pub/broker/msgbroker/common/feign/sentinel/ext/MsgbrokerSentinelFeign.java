...
package pub.broker.msgbroker.common.feign.sentinel.ext;
 ...
 * @date 2020/6/9
 */
public final class MsgbrokerSentinelFeign {

	private MsgbrokerSentinelFeign() {

	}

	public static MsgbrokerSentinelFeign.Builder builder() {
		return new MsgbrokerSentinelFeign.Builder();
	}
	...
	public static final class Builder extends Feign.Builder implements ApplicationContextAware {
		...
		@Override
		public MsgbrokerSentinelFeign.Builder contract(Contract contract) {
			...
			super.invocationHandlerFactory(new InvocationHandlerFactory() {
				...
				public InvocationHandler create(Target target, Map<Method, MethodHandler> dispatch) {
					...
					if (void.class != fallback) {
						...
						return new MsgbrokerSentinelInvocationHandler(target, dispatch,
					...
					if (void.class != fallbackFactory) {
						...
						return new MsgbrokerSentinelInvocationHandler(target, dispatch, fallbackFactoryInstance);
					}
					return new MsgbrokerSentinelInvocationHandler(target, dispatch);
				}
