 ...
 */
@Slf4j
public class MsgbrokerSentinelInvocationHandler implements InvocationHandler {
	...
	MsgbrokerSentinelInvocationHandler(Target<?> target, Map<Method, InvocationHandlerFactory.MethodHandler> dispatch,
	...
	public boolean equals(Object obj) {
		if (obj instanceof SentinelInvocationHandler) {
			MsgbrokerSentinelInvocationHandler other = (MsgbrokerSentinelInvocationHandler) obj;
